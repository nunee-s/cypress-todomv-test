...
export interface ClientSocket<TDriver, TContext, TElement, TSelector> {
    ...
    request(name: 'EyesManager.makeEyes', options: {
    ...
    command(name: 'Driver.getElementRect', handler: (options: {
        driver: TDriver;
        element: TElement;
    }) => Promise<Region>): () => void;
...
export interface ServerSocket<TDriver, TContext, TElement, TSelector> {
    ...
    request(name: 'Driver.getElementRect', options: {
        driver: TDriver;
        element: TElement;
    }): Promise<Region>;
    ...
    command(name: 'EyesManager.makeEyes', handler: (options: {
        manager: Ref<EyesManager<TDriver, TElement, TSelector>>;
        driver: TDriver;
        config?: EyesConfig<TElement, TSelector>;
        on?: (event: string, data?: Record<string, any>) => any;
